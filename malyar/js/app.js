...
$(function(){
	...
	$("#gotocalc").on("click", function(){
		$("html,body").animate({ scrollTop: '470px'}, 1500);
	});
	...
	$(window).scroll(function(e){
		...
		$('.prlx1').css('top',(700-(scrolled*.6))+'px');
		$('.prlx2').css('top',(2650-(scrolled*.25))+'px'); 
	});


	$(".lab").on("click", function(){
		$(".lab").prop( "checked", true).parent().removeClass("has");
	...
	$(".width16").on("click", function(){
		$(".width16").removeClass("has");
