...
$(function(){
	...
	$('.uslygi').on('click', function(e){
		$('html,body').stop().animate({ scrollTop: $('#uslygi').offset().top }, 1000);
		e.preventDefault();
		$('.menuadaptuv').removeClass('in');
	});
